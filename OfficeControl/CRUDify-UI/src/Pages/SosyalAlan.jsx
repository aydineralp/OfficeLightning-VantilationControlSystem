...
import sosyalAlanPlan from "../assets/bgSosyalAlan.png"; // Görseli içe aktar,
...
const SosyalAlan = () => {
  ...
  useEffect(() => {
    ...
    GetRoomsByLocationName("Sosyal Alan");
    GetTagsByLocationName("Sosyal Alan");
  }, []);
